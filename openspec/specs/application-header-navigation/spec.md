# application-header-navigation Specification

## Purpose

Define global application header navigation, breadcrumb metadata, contextual navigation, and role-aware course header behavior.
