...
- [x] 2.3 Add a reusable code block component with lazy-loaded Shiki highlighting, light/dark themes, copy action, and plain-code fallback.
- [x] 2.4 Render spoiler blocks as clickable/keyboard-accessible collapsible sections with nested rank-ordered content.
- [x] 2.5 Render assignment blocks as cards that link to the existing course task route.
- [x] 2.6 Extract or centralize reusable course color theme classes for use by both course cards and the course page hero.
