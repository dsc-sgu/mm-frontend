...
The system SHALL expose `/repositories/my` only to course students and expose `/repositories/[student-username]` only to course teachers for known students in the course.

#### Scenario: Student opens own repository page
- **WHEN** an authenticated course student navigates to `/courses/[course-slug]/repositories/my`
- **THEN** the system renders the authorized student's repository placeholder page

#### Scenario: Teacher opens my repository page
- **WHEN** an authenticated course teacher navigates to `/courses/[course-slug]/repositories/my`
...
- **WHEN** an authenticated course student navigates to `/courses/[course-slug]/repositories/my/commits`
