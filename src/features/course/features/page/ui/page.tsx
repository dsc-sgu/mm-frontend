...
export function CoursePage({ course }: { course: CoursePageModel }) {
  ...
  return (
    <main
      className={cn(
        'mx-auto flex w-full max-w-6xl flex-col sm:px-6 sm:py-6 lg:px-8'
      )}
    >
      <section
        className={cn(
      ...
      >
        ...
        <div className="relative z-10 w-full sm:max-w-3xl">
          ...
          <p
            className={cn(
              'mt-4 max-w-2xl text-base leading-7 text-foreground/85',
              'sm:text-lg'
            )}
          >
            {course.description}
          ...
          <div
            className={cn(
              'mt-5 flex max-w-2xl flex-col items-start gap-2 sm:flex-row',
              'sm:flex-wrap'
            )}
          >
...
export function CoursePageLoading() {
  return (
    ...
    >
      ...
      <div
        className={cn(
          'mt-8 space-y-4 rounded-3xl border border-border bg-card p-6',
          'shadow-sm sm:p-8'
        )}
      >
