import { SessionScheme } from '@/features/auth/model/schema';
import type {
  FetchSessionResponse,
  LoginRequest,
  RegisterRequest,
} from '@/features/auth/model/types';
import * as mockAuthApi from '@/features/auth/api/mock';
import axios from 'axios';
import * as v from 'valibot';

// TODO: Use VITE_BASE_API_URL env

export type { FetchSessionResponse } from '@/features/auth/model/types';
